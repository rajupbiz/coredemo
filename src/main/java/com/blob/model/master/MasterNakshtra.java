...
@Entity
@Table(name="master_nakshtra")
public class MasterNakshtra {
	...
	public String getNakshtraDesc() {
		return nakshtraDesc;
	}

	public void setNakshtraDesc(String nakshtraDesc) {
		this.nakshtraDesc = nakshtraDesc;
	}
